...
public class QLKhachHangPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblDSKhachHang.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        DialogKhachHang.txtID.setEditable(true);
    ...
    private void tblDSKhachHangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDSKhachHangMouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            ...
            p.setDiachi(tblDSKhachHang.getValueAt(i, 7).toString());
            p.setSdt(tblDSKhachHang.getValueAt(i, 4).toString());
            p.setGioitinh(tblDSKhachHang.getValueAt(i, 3).toString());
            p.setEmail(tblDSKhachHang.getValueAt(i, 5).toString());
            p.setNgaydangky(tblDSKhachHang.getValueAt(i, 6).toString());

            kh.setForm(p);
            kh.setVisible(true);
            DialogKhachHang.txtID.setEditable(false);
    ...
    public static javax.swing.JTable tblDSKhachHang;
    ...
    void findkh() {
        ...
        int i = 1;
        try {
            for (KhachHang kh : kh.findKH(txtTimKiem.getText())) {
                Object[] row = {
                   i++, kh.getID(), kh.getHoten(), kh.getGioitinh(), kh.getSdt(), kh.getEmail(), kh.getNgaydangky(), kh.getDiachi()
                };
                model.addRow(row);
