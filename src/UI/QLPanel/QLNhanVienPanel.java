...
public class QLNhanVienPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblDSNhanVien.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã NV", "Họ tên", "SĐT", "Giới tính", "Năm sinh", "Email", "Chức vụ", "Trạng thái"
            }
        ) {
        ...
        if (tblDSNhanVien.getColumnModel().getColumnCount() > 0) {
            tblDSNhanVien.getColumnModel().getColumn(0).setMinWidth(70);
            tblDSNhanVien.getColumnModel().getColumn(0).setPreferredWidth(70);
            tblDSNhanVien.getColumnModel().getColumn(0).setMaxWidth(70);
            ...
            tblDSNhanVien.getColumnModel().getColumn(2).setMinWidth(200);
            tblDSNhanVien.getColumnModel().getColumn(2).setPreferredWidth(200);
            tblDSNhanVien.getColumnModel().getColumn(2).setMaxWidth(200);
        }
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        DialogNhanVien.txtMaNV.setEditable(true);
    ...
    private void tblDSNhanVienMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDSNhanVienMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            nv.setGioiTinh(tblDSNhanVien.getValueAt(i, 4).toString());
            nv.setSdt(tblDSNhanVien.getValueAt(i, 3).toString());
            nv.setNamSinh(tblDSNhanVien.getValueAt(i, 5).toString());
            nv.setEmail(tblDSNhanVien.getValueAt(i, 6).toString());
            nv.setChucVu(tblDSNhanVien.getValueAt(i, 7).toString());
            nv.setTinhTrang(tblDSNhanVien.getValueAt(i, 8).toString());
            dialogNhanVien.setForm(nv);
            dialogNhanVien.setVisible(true);
            DialogNhanVien.txtMaNV.setEditable(false);
        }
    ...
    void FindNhanVien() {
        ...
        try {
            for (NhanVien nv : dao.findNhanVien(txtTimKiem.getText())) {
                Object[] row = {
                    i++, nv.getMaNV(), nv.getTenNV(), nv.getGioiTinh(), nv.getSdt(),
                    nv.getNamSinh(),nv.getEmail() ,nv.getChucVu(), nv.getTinhTrang()
                };
                model.addRow(row);
            }
        } catch (Exception e) {
