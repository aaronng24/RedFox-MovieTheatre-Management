...
import UI.QLPanel.DiaLogTaiKhoanDangNhap;
...
public class DialogNhanVien extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cboTrangThai.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Còn làm", "Nghỉ làm" }));
        ...
        cboVaiTro.setPreferredSize(new java.awt.Dimension(200, 30));
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        ...
        String chucvu = txtEmail.getText();
        String email=txtEmail.getText();
        if (dao.validate(manv, tennv, sdt, namsinh,email, chucvu)) {
    ...
    void setForm(NhanVien nv) {
        ...
        cboVaiTro.setSelectedItem(nv.getChucVu());
...
//                this.clearForm(); // xóa trắng form
    ...
    void TaiKhoanNV() {
        try {
            ...
            ResultSet rs = st.executeQuery("select * from acc_login,nhanvien where id_nv=username and id_nv='" + id + "'");
            ...
            if (txtMaNV.getText().equals("")) {
                DiaLogTaiKhoanDangNhap sighUpFrame = new DiaLogTaiKhoanDangNhap();
            ...
            if (username.isBlank()) {
                ...
                DiaLogTaiKhoanDangNhap sighUpFrame = new DiaLogTaiKhoanDangNhap();
                sighUpFrame.setVisible(true);
                sighUpFrame.getManv(id);
                sighUpFrame.getMK(password);
